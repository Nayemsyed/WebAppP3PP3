...
namespace WebAppP3PP3.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(Phase3pp3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subjects != null ? 
                          ...
                          Problem("Entity set 'Phase3pp3Context.Subjects'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Phase3pp3Context.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
